...
<script>
    $.getJSON('http://api.openweathermap.org/data/2.5/weather?id=<?php echo $CONFIG['openweather.api']['id'] ?>&appid=<?php echo $CONFIG['openweather.api']['appid'] ?>&units=<?php echo $CONFIG['openweather.api']['units'] ?>',
        function(data) {
